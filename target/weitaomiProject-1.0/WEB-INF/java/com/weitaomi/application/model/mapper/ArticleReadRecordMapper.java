...
public interface ArticleReadRecordMapper extends IBaseMapper<ArticleReadRecord> {
    ...
    int getArticleReadRecord(@Param("memberId") Long memberId, @Param("articleId") Long articleId);
}