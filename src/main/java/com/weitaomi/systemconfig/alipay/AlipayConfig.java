...
public class AlipayConfig {
	...
	//TODO
	public static String notify_url = "http://weitaomi.cn/pc/admin/paymemberCallBack/verifyAlipayNotify";
	//批量付款通知页面
	public static String batchPay_notify_url = "http://weitaomi.cn/pc/admin/paymemberCallBack/verifyAlipayNotify";
