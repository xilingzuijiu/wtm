...
(function(){
    ...
    vCode.prototype.drawCode = function(code, index){
        ...
        dom.style.cssText = [
            ...
            "transform:rotate(" + randint(0,0) + "deg)",
            "-ms-transform:rotate(" + randint(0,0) + "deg)",
            "-moz-transform:rotate(" + randint(0,0) + "deg)",
            "-webkit-transform:rotate(" + randint(0,0) + "deg)",
            "-o-transform:rotate(" + randint(0,0) + "deg)",
